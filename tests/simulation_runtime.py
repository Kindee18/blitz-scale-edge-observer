...
class MockRedisModule:
    @staticmethod
    async def from_url(*args, **kwargs): return MockRedisClient()

class MockOTel:
    trace = MagicMock()
    class TracerProvider:
        def get_tracer(self, *args): return MagicMock()
...
async def run_simulation():
    ...
    records = [
        {
            "kinesis": {
                "data": base64.b64encode(json.dumps({
                    "game_id": "NFL_101", "player_id": "P1", "timestamp": 100,
        ...
        },
        {
            "kinesis": {
                "data": base64.b64encode(json.dumps({
                    "game_id": "NFL_101", "player_id": "P1", "timestamp": 200,
    ...
    with patch('streaming.delta_processor_lambda.get_redis') as mock_redis_getter, \
